...
void jugador::buscarYAtacar(int pos, int cantidad, celula **head){
	/* Esta función deberá llamar a 'takeDamage()' cuando encuentre la célula objetivo*/

}

void jugador::buscarYDefender(int pos, int cantidad, celula **head){
	/* Esta función deberá llamar a 'defend()' cuando encuentre la célula objetivo*/
...
void jugador::genCells(int cant, celula **head){
	...
	restantes = cant;
	energia = 0;
	/* Esta función deberá crear y enlazar las células, con hp = 1 + random() % cant; */
...
void celula::takeDamage(int dir, int cantidad, auto *j, celula **head){
	/* Función recursiva que dañará las células según corresponda */
}

void celula::defend(int dir, int cantidad, auto *j){
	/* Función recursiva que defenderá las células según corresponda */
}